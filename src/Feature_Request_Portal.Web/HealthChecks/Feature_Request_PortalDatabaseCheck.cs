...
public class Feature_Request_PortalDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public Feature_Request_PortalDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
