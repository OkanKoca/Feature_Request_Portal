...
{
    [DbContext(typeof(Feature_Request_PortalDbContext))]
    [Migration("20260810191844_Added_FeatureRequests")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Feature_Request_Portal.Authors.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Feature_Request_Portal.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Feature_Request_Portal.Comments.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Feature_Request_Portal.FeatureRequests.FeatureRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Feature_Request_Portal.Votes.Vote", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Feature_Request_Portal.Books.Book", b =>
                {
                    b.HasOne("Feature_Request_Portal.Authors.Author", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Feature_Request_Portal.Comments.Comment", b =>
                {
                    b.HasOne("Feature_Request_Portal.FeatureRequests.FeatureRequest", null)
                        .WithMany("Comments")
