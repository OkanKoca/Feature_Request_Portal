...
public static class Feature_Request_PortalEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE Feature_Request_PortalModuleExtensionConfigurator CLASS (in the Domain.Shared project)
