...
public class Feature_Request_PortalEntityFrameworkCoreTestModule : AbpModule
{
    ...
    private void ConfigureInMemorySqlite(IServiceCollection services)
    {
        ...
        _database.CreateTables(
            new Feature_Request_PortalDbContext(new DbContextOptionsBuilder<Feature_Request_PortalDbContext>().UseSqlite(_database.ConnectionString).Options));
